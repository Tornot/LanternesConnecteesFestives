 ...
 *
 */
/* BARv2 est l'exemple ReadAndWrite dans on a decoupe les parties
 * de lecture et d'ecriture en des fonctions separees.
 */
...
void setup() {
    pinMode(16, OUTPUT);    
    digitalWrite(16, HIGH); //Other RC522 connected but non active
...
void loop()
{
    ...
    ReadDataFromRFIDTag(mfrc522);
    WriteDataToRFIDTag(mfrc522);
